...
.. code-block:: fortran
   ...
   program positional_example
       ...
       ! Retrieve values
       call args%get_string("input", input_file)
       call args%get_string("output", output_file)
...
.. code-block:: fortran
   ...
   program types_example
       ...
       call args%get_string("name", name)
       call args%get_integer("iterations", iterations)
       call args%get_real("threshold", threshold)
       call args%get_logical("debug", debug)
...
- ``nargs="?"`` (ARG_OPTIONAL): Zero or one argument
- ``nargs="*"`` (ARG_ZERO_OR_MORE): Zero or more arguments
- ``nargs="+"`` (ARG_ONE_OR_MORE): One or more arguments (required)
...
.. code-block:: fortran
   ...
   program complete_example
       ...
       call args%get_string("format", format_str)
       call args%get_integer("verbose", verbosity)
       call args%get_logical("force", force)
